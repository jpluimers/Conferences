...
type
  ...
  public
    ...
    function ToString(const astartIndex: Integer; const alength: Integer): string; overload;
    function Append(const avalue: Char; const arepeatCount: Integer): StringBuilder; overload;
    function Append(const avalue: string): StringBuilder; overload;
    function Append(const avalue: string; const astartIndex: Integer; const acount: Integer): StringBuilder; overload;
    function AppendLine: StringBuilder; overload;
    function AppendLine(const avalue: string): StringBuilder; overload;
    function Insert(const aindex: Integer; const avalue: string; const acount: Integer): StringBuilder; overload;
    ...
    function Insert(const aindex: Integer; const avalue: string): StringBuilder; overload;
    ...
    function AppendFormat(const aformat: string; const aarg0: TCTObject): StringBuilder; overload;
    function AppendFormat(const aformat: string; const aarg0: TCTObject; const aarg1: TCTObject): StringBuilder; overload;
    function AppendFormat(const aformat: string; const aarg0: TCTObject; const aarg1: TCTObject; const aarg2: TCTObject): StringBuilder; overload;
    function Replace(const aoldValue: string; const anewValue: string): StringBuilder; overload;
    function Replace(const aoldValue: string; const anewValue: string; const astartIndex: Integer; const acount: Integer): StringBuilder; overload;
...
constructor StringBuilder.Create(const avalue: string; const acapacity: Integer);
begin
  CTCreateObject('System.Text.StringBuilder', [avalue, acapacity]);
end;

constructor StringBuilder.Create(const avalue: string; const astartIndex: Integer; const alength: Integer; const acapacity: Integer);
begin
...
function StringBuilder.ToString(const astartIndex: Integer; const alength: Integer): string;
begin
...
function StringBuilder.Append(const avalue: string; const astartIndex: Integer; const acount: Integer): StringBuilder;
begin
...
function StringBuilder.Insert(const aindex: Integer; const avalue: string; const acount: Integer): StringBuilder;
begin
...
function StringBuilder.Insert(const aindex: Integer; const avalue: string): StringBuilder;
begin
...
function StringBuilder.AppendFormat(const aformat: string; const aarg0: TCTObject): StringBuilder;
begin
  Result := StringBuilder(CTFindRef(StringBuilder, CTMethodCall('AppendFormat', [aformat, aarg0])));
  ResultObjectsClear;
end;

function StringBuilder.AppendFormat(const aformat: string; const aarg0: TCTObject; const aarg1: TCTObject): StringBuilder;
begin
  Result := StringBuilder(CTFindRef(StringBuilder, CTMethodCall('AppendFormat', [aformat, aarg0, aarg1])));
  ResultObjectsClear;
end;

function StringBuilder.AppendFormat(const aformat: string; const aarg0: TCTObject; const aarg1: TCTObject; const aarg2: TCTObject): StringBuilder;
begin
  Result := StringBuilder(CTFindRef(StringBuilder, CTMethodCall('AppendFormat', [aformat, aarg0, aarg1, aarg2])));
  ResultObjectsClear;
end;

function StringBuilder.Replace(const aoldValue: string; const anewValue: string): StringBuilder;
begin
  Result := StringBuilder(CTFindRef(StringBuilder, CTMethodCall('Replace', [aoldValue, anewValue])));
  ResultObjectsClear;
end;

function StringBuilder.Replace(const aoldValue: string; const anewValue: string; const astartIndex: Integer; const acount: Integer): StringBuilder;
begin
